  					...
  					<div class="card-body" style="margin-top: -30px;">
					    ...
					    <div class="d-flex justify-content-center align-items-center">
								<div class="buttons text-center">
									<a href="http://goldenminds.edu.test/academics/senior-high-school"
									target="_blank" title="Read more information about GMC-SHS" class="btn btn-light back_button mt-2">
							  		{{ __('Read More Info') }}
			 						</a>
								 	<a href="http://admission.goldenminds.edu.test/senior-high-school/registration?step=1&form_mode=applying-for" class="btn btn-light next_button mt-2">
  			...
  			<div class="col-md-6">
  				<x-card class="card_box border-0 rounded-4">
  					...
  					<div class="card-body" style="margin-top: -30px;">
					    ...
					    <div class="d-flex justify-content-center align-items-center">
								<div class="buttons text-center">
									<a href="http://goldenminds.edu.test/academics/basic-education" title="Read more information about GMA-BE"
